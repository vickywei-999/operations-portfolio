...
**角色为什么会「不像同一个角色」？一套流程能不能让问题只解决一次？**

这份方法文档来自 AIMON 项目的实践：把「人设跳脱、语言与动作不搭、生成不稳定」这三类反复出现的问题，整理成五个阶段的流程——Persona 设定、分镜拆解、AIGC 生成、质量检查、迭代与沉淀。每个阶段只讲三件事：**做什么、产出什么、怎么算过关**；并附一份换新角色开工前的自检清单。文中交互示例经过脱敏，不含内部提示词与未公开素材。
